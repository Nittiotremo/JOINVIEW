...
INSERT INTO TURMA(CODTURMA,CODDISC_FK,CODPROF_FK,ANO,HORARIO) VALUES(1,1,212131,2015, '11H-12H')
INSERT INTO TURMA(CODTURMA,CODDISC_FK,CODPROF_FK,ANO,HORARIO) VALUES(2,1,212131,2015, '13H-14H')
INSERT INTO TURMA(CODTURMA,CODDISC_FK,CODPROF_FK,ANO,HORARIO) VALUES(3,2,192011,2015, '08H-09H')
INSERT INTO TURMA(CODTURMA,CODDISC_FK,CODPROF_FK,ANO,HORARIO) VALUES(4,4,192011,2015, '07H-08H')
INSERT INTO TURMA(CODTURMA,CODDISC_FK,CODPROF_FK,ANO,HORARIO) VALUES(5,4,212131,2015, '10H-11H')
SELECT * FROM TURMA
SELECT * FROM DISCIPLINAS
...
INSERT INTO HISTORICO(CODALUNO_FK,CODDISC_FK,CODTURMA_FK,CODPROF_FK,ANO,FREQUENCIA,NOTA) VALUES(2015010101, 1, 1, 212131, '2015', '66.76','3')
INSERT INTO HISTORICO(CODALUNO_FK,CODDISC_FK,CODTURMA_FK,CODPROF_FK,ANO,FREQUENCIA,NOTA) VALUES(2015010102, 1, 2, 212131, '2015', '46.44','4')
INSERT INTO HISTORICO(CODALUNO_FK,CODDISC_FK,CODTURMA_FK,CODPROF_FK,ANO,FREQUENCIA,NOTA) VALUES(2015010103, 2, 3, 192011, '2015', '78.88','8')  
INSERT INTO HISTORICO(CODALUNO_FK,CODDISC_FK,CODTURMA_FK,CODPROF_FK,ANO,FREQUENCIA,NOTA) VALUES(2015010104, 3, 4, 192011, '2015', '98.11','9') 
INSERT INTO HISTORICO(CODALUNO_FK,CODDISC_FK,CODTURMA_FK,CODPROF_FK,ANO,FREQUENCIA,NOTA) VALUES(2015010105, 4, 5, 122135, '2015', '100.00','10')
