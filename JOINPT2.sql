...
CREATE OR REPLACE VIEW EXA2 AS 
SELECT NOTA,CODDISC_FK,ANO FROM
HISTORICO
WHERE ANO = ('2015')
AND CODDISC_FK  = 'POO';
...
CREATE OR REPLACE FUNCTION NOTAPOO() RETURNS SETOF HISTORICO AS
$$
	BEGIN
	 RETURN QUERY SELECT * FROM HISTORICO WHERE NOTA > 6;
	END;
$$LANGUAGE plpgsql;
